...
const Card = () => {
    return (
        <div className="grid grid-cols-2 lg:grid-cols-5 md:grid-cols-3 gap-5 max-w-[1500px] mx-auto my-20 px-2">
            {/* first Card */}
            <div className="border border-gray-600 rounded-xl bg-gray-100 scale-100 transition-all duration-300 hover:scale-105 hover:shadow-cyan-500/50">
